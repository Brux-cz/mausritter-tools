...
from tests.test_character_generator import (
    ...
    test_generate_distinctive_trait,
    test_generate_distinctive_trait_multiple_times,
    test_select_weapon,
    test_select_weapon_specific,
    test_select_weapon_multiple_times,
...
def main():
    ...
    tests = [
        ...
        (test_generate_distinctive_trait, "test_generate_distinctive_trait"),
        (test_generate_distinctive_trait_multiple_times, "test_generate_distinctive_trait_multiple_times"),
        (test_select_weapon, "test_select_weapon"),
        (test_select_weapon_specific, "test_select_weapon_specific"),
        (test_select_weapon_multiple_times, "test_select_weapon_multiple_times"),
